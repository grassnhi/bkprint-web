  ...
  return (
    <div className="biggestcontainer-help">
      <div className="header-help">
        <div className="header-choose-help">
          <img className="bklogo-choose-help" src={logo} alt="bklogo" />
          <div className="name-choose-help">BK Fast Automated Printing Service </div>
        </div>
